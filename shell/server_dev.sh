...
start()
{
   ...
   /opt/apps/resin/bin/resin.sh -conf /opt/nuc_git/bp-roast/resinConf/resin_bp_roast_server_dev.xml --resin-home /opt/apps_install/resin-4.0.44 start
...
stop()
{
   /opt/apps/resin/bin/resin.sh -conf /opt/nuc_git/bp-roast/resinConf/resin_bp_roast_server_dev.xml --resin-home /opt/apps_install/resin-4.0.44 stop
}
